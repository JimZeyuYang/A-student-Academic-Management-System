...
import static GUI.mainMenu.outputGrade;
import java.util.logging.Level;
import java.util.logging.Logger;
import javax.swing.JOptionPane;
import static GUI.mainMenu.did;

public class tigerNetLogin extends javax.swing.JFrame {

    
    public tigerNetLogin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(249, 155, 14));
        ...
        jLabel1.setText("Ridley College");
        ...
        jLabel2.setFont(new java.awt.Font("Trajan Pro", 0, 13)); // NOI18N
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        JOptionPane.showMessageDialog(rootPane,"WARNING!\nThis process might take 30 seconds "
                + "up to a couple minutes depends on your internet quality\n"
                + "Please be Patient");
        try {
            outputGrade(username.getText(),password.getText());
        } catch (InterruptedException ex) {
            Logger.getLogger(tigerNetLogin.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tigerNetLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tigerNetLogin().setVisible(true);
            }
        });
    }
